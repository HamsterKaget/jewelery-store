...
<head>
    ...
    <style>
        ...
        .bg-overlay::before {
            ...
            width: 100%;
            height: 100%;
            background-image: url({{ asset('dev/logo-wgc.png') }});
                ...
                <div class="max-w-md w-full space-y-8">
                    ...
                    <form class="mt-8 space-y-6" action="{{ route('register') }}" method="POST">
                        ...
                        <div class="mt-8 content-center">
                            ...
                            <input class="w-full content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-red-500 @error('name') border-red-500 @enderror"
                        ...
                        <div class="mt-8 content-center">
                            ...
                            <input class="w-full content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-red-500 @error('email') border-red-500 @enderror"
                        ...
                        <div class="mt-8 content-center">
                            ...
                            <input class="w-full content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-red-500 @error('password') border-red-500 @enderror"
                        ...
                        <div class="mt-8 content-center">
                            ...
                            <input class="w-full content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-red-500"
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <input id="remember_me" name="remember" type="checkbox" class="h-4 w-4  focus:ring-rose-400 border-gray-300 rounded">
                                <label for="remember_me" class="ml-2 block text-sm text-gray-900">
                                    Remember me
                                </label>
                            </div>
                            <div class="text-sm">
                                <a href="{{ route('password.request') }}" class="text-red-400 hover:text-rose-500">
                                    Forgot your password?
                                </a>
                            </div>
                        </div>
                        <div>
                            <button type="submit" class="w-full flex justify-center bg-gradient-to-r from-red-500 to-rose-600  hover:bg-gradient-to-l hover:from-rose-500 hover:to-red-600 text-gray-100 p-4  rounded-full tracking-wide font-semibold  shadow-lg cursor-pointer transition ease-in duration-500">
                                Sign Up
                            </button>
                        </div>
                        <p class="flex flex-col items-center justify-center mt-10 text-center text-md text-gray-500">
                            <span>Already have an account?</span>
                            <a href="{{ route('login') }}" class="text-red-400 hover:text-rose-500 no-underline hover:underline cursor-pointer transition ease-in duration-300">Log In</a>
                        </p>
                    </form>
                </div>
            </div>
