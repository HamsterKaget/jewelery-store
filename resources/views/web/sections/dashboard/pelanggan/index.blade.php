...
<div class="grid lg:grid-cols-3 grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
    ...
    <div class="p-4 sm:col-span-full py-6 bg-white dark:bg-slate-800 shadow rounded-lg">
        <div class="mb-4 text-center">
            <h2 class="text-xl font-extrabold leading-none tracking-tight text-gray-900 md:text-3xl lg:text-4xl dark:text-white">Pelanggan</h2>
                ...
                <div class="relative w-full max-w-lg max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="px-6 py-6 lg:px-8 rounded-lg">
                            <h3 id="titleSimpanData" class="mb-4 text-xl font-medium text-gray-900 dark:text-white" >Tambah Data Pelanggan</h3>
                            ...
                            >
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex">
                                            <input type="email" id="email" name="email" class="rounded-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                    </div>
                                    <div>
...
<script>
     ...
     *
     */
    function fetchData(params, pageUrl = "{{ route('pelanggan.get-data') }}") {
        axios.get(pageUrl, {
            params: params
        })
    ...
    function submitData() {
        ...
        axios.post("{{ route('pelanggan.create') }}", formData)
            .then(response => {
    ...
    function edit(id = null) {
        const form = document.getElementById('createForm');
        const editUrl = "{{ route('pelanggan.edit') }}";
    ...
    function handleDeleteAction(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios
                .post(`{{ route('pelanggan.delete') }}`, {
                    _method: 'DELETE',
                    id: id
                })
                .then(response => {
                    // Handle the response (e.g., show a success message)
                    console.log('Pelanggan deleted successfully', response);
                    fetchData(); // Refresh the table after deletion
                    Swal.fire({
                        title: "Deleted!",
