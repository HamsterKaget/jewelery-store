...
<div class="grid lg:grid-cols-3 grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
    ...
    <div class="p-4 sm:col-span-full py-6 bg-white dark:bg-slate-800 shadow rounded-lg">
        <div class="mb-4 text-center">
            <h2 class="text-xl font-extrabold leading-none tracking-tight text-gray-900 md:text-3xl lg:text-4xl dark:text-white">Jenis Emas</h2>
                ...
                <div class="relative w-full max-w-lg max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="px-6 py-6 lg:px-8 rounded-lg">
                            <h3 id="titleSimpanData" class="mb-4 text-xl font-medium text-gray-900 dark:text-white" >Tambah Data Jenis Emas</h3>
                            ...
                            >
                                ...
                                <div>
                                    <label for="nama" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jenis Emas</label>
                                    <div class="flex">
...
<script>
     ...
     *
     */
    function fetchData(params, pageUrl = "{{ route('jenis-emas.get-data') }}") {
        axios.get(pageUrl, {
            params: params
        })
    ...
    function submitData() {
        ...
        axios.post("{{ route('jenis-emas.create') }}", formData)
            .then(response => {
            ...
            .catch(error => {
                ...
                console.error('Error creating Jenis Emas', error);
    ...
    function edit(id = null) {
        const form = document.getElementById('createForm');
        const editUrl = "{{ route('jenis-emas.edit') }}";
    ...
    function handleDeleteAction(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios
                .post(`{{ route('jenis-emas.delete') }}`, {
                    _method: 'DELETE',
                    id: id
                })
                .then(response => {
                    // Handle the response (e.g., show a success message)
                    console.log('Jenis Emas deleted successfully', response);
                    fetchData(); // Refresh the table after deletion
                    Swal.fire({
                        title: "Deleted!",
                ...
                .catch(error => {
                    // Handle any errors (e.g., show an error message)
                    console.error('Error deleting Jenis Emas', error);
                    handleAlert('Something Wrong!', error, 'error');
