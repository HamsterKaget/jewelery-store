...
<div class="grid lg:grid-cols-3 grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
    ...
    <div class="p-4 sm:col-span-full py-6 bg-white dark:bg-slate-800 shadow rounded-lg">
        <div class="mb-4 text-center">
            <h2 class="text-xl font-extrabold leading-none tracking-tight text-gray-900 md:text-3xl lg:text-4xl dark:text-white">Permission</h2>
                ...
                <div class="relative w-full max-w-lg max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="px-6 py-6 lg:px-8 rounded-lg">
                            <h3 id="titleSimpanData" class="mb-4 text-xl font-medium text-gray-900 dark:text-white" >Tambah Permission</h3>
                            ...
                            >
                                ...
                                <div>
                                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Permission / URL</label>
                                    <div class="flex">
...
<script>
     ...
     *
     */
    function fetchData(params, pageUrl = "{{ route('permission.get-data') }}") {
        axios.get(pageUrl, {
            params: params
        })
    ...
    function submitData() {
        ...
        axios.post("{{ route('permission.create') }}", formData)
            .then(response => {
    ...
    function edit(id = null) {
        const form = document.getElementById('createForm');
        const editUrl = "{{ route('permission.edit') }}";
        ...
        OperationModal('Update Data', 'Simpan Perubahan')
            ...
            axios.get(`${editUrl}?id=${id}`)
                .then(response => {
                    ...
                    inputField = form.querySelector('#nama_toko');
                    inputField.value = response.data.nama_toko;

                    inputField = form.querySelector('#alamat');
                    inputField.value = response.data.alamat;

                    inputField = form.querySelector('#npwp');
                    inputField.value = response.data.npwp;
                })
                .catch(error => {
